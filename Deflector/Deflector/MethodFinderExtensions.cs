...
namespace Deflector
{
    ...
    {
        public static TMethod GetBestMatch<TMethod>(this IEnumerable<TMethod> targetMethods, Type[] typeArguments, Type[] parameterTypes, Type returnType)
        ...
        public static MethodBase GetBestMatch(this IEnumerable<MethodBase> candidateMethods, MethodBase currentMethod)
        {
            ...
            if (constructorInfo != null)
            {
                return candidateMethods.GetBestMatch(typeArguments,
                    parameterTypes, constructorInfo.DeclaringType);
            }
